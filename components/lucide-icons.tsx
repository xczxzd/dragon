...
// Using Heroicons as a substitute for Lucide icons for simplicity
...
export const Activity: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h.007v.007H3.75V12zm.75-3h.007v.007H4.5V9zm.75 6h.007v.007H5.25v-.007zm.75-3h.007v.007H6V12zm2.25-4.5h.007v.007H8.25V7.5zm.75 3h.007v.007H9V10.5zm.75 3h.007v.007H9.75V13.5zm.75-6h.007v.007H10.5V7.5zm.75 3h.007v.007H11.25V10.5zm.75 3h.007v.007H12V13.5zm2.25-4.5h.007v.007H14.25V9zm.75 3h.007v.007H15V12zm.75 3h.007v.007H15.75v-.007zm.75-3h.007v.007H16.5V12zm.75-3h.007v.007H17.25V9zm.75 3h.007v.007H18V12zm.75 3h.007v.007H18.75v-.007zm.75-6h.007v.007H19.5V9z" />
  </svg>
);
